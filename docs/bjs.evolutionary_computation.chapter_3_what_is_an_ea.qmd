...
---
format:
  html: {toc: true, toc-depth: 4, theme: cosmo, output-file: bjs.evolutionary_computation.chapter_3_what_is_an_ea.html}
...
<script src="bjs.evolutionary_computation.chapter_3_what_is_an_ea_files/md-default0.js" type="text/javascript"></script><script src="bjs.evolutionary_computation.chapter_3_what_is_an_ea_files/md-default1.js" type="text/javascript"></script>
...
::: {.printedClojure}
```clojure
#'bjs.evolutionary-computation.chapter-3-what-is-an-ea/quality
...
::: {.printedClojure}
```clojure
#'bjs.evolutionary-computation.chapter-3-what-is-an-ea/mutate
...
```{=html}
<div><pre><small><small>source: src/bjs/evolutionary_computation/chapter_3_what_is_an_ea.clj</small></small></pre></div>
```
