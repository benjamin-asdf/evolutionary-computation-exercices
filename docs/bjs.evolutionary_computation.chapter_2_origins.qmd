...
---
format:
  html: {toc: true, toc-depth: 4, theme: cosmo, output-file: bjs.evolutionary_computation.chapter_2_origins.html}
...
<script src="bjs.evolutionary_computation.chapter_2_origins_files/md-default0.js" type="text/javascript"></script><script src="bjs.evolutionary_computation.chapter_2_origins_files/md-default1.js" type="text/javascript"></script>
...
```{=html}
<img class="clay-image" src="https://upload.wikimedia.org/wikipedia/commons/4/43/Darwin_Tree_1837.png" />
```
...
```{=html}
<div><pre><small><small>source: src/bjs/evolutionary_computation/chapter_2_origins.clj</small></small></pre></div>
```
